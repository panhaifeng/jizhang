...
<form id="form1" name="form1" method="post" action="{url controller=$smarty.get.controller action=SaveTzKucun}">
  <table id="mainTable">
   ...
   <!--  <tr>
    ...
    <tr>
      <td class="title">余存-件数：</td>
      <td><input name="cntJianKucun" type="text"  id="cntJianKucun" value="{$aRow.cntJianKucun}" readonly size="10"/>
     </td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="title">实际余存-件数：</td>
      <td><input name="jianReal" type="text"  id="jianReal" value="" size="10"/>
     </td>
    </tr>
    <tr>
