...
<div class="panel panel-info">
  <div class="panel-heading"><h3 class="panel-title" style="text-align:left;">分匹计划</h3></div>
  ...
  <div style="overflow:auto; border:0px solid #bce8f1; margin-bottom:10px; max-height:290px;">
    <div class="table-responsive" style="width:{$tbl_other_width|default:"100%"};">
      <table class="table table-condensed table-striped trRowMore" id='table_fenpi' key='fenpiId[]' removeUrl='?controller={$smarty.get.controller}&action={$Remove2Ajax|default:Remove2Ajax}'>
        <thead>
          <tr>
            {foreach from=$fenpiSon item=item key=key}
