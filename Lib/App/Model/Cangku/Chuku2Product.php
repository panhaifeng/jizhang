...
class Model_Cangku_Chuku2Product extends TMIS_Model_Cangku_Son {
	...
	var $fldCopyMain = array('kuwei','supplierId','kind');
	var $fldCopySon = array('productId','pihao','ganghao','dengji','cntJian');
   ...
   var $hasMany = array(
		array(
			'tableClass' => 'Model_Cangku_Chengpin_Madan',
