...
<body>
 <form name="form1" id="form1" action="{url controller=$smarty.get.controller action='SaveTiaoku'}" enctype="multipart/form-data" method="post">
<div class="main">
  <div class="pull-left">
  <table class="table">
    <tr>
    ...
    <td><input type="text" name="kucunWei" id="kucunWei" value="{$aRow.kucunWei}" readonly></td>
    </tr>
<!--     <tr>
  ...
  <tr>      
    <td class="title">调整数量：</td>
    <td>
      <input type="text" name="kucunCnt" id="kucunCnt" value="{$aRow.kucunCnt}" ><span class="bitian">*</span>
      <input type="hidden" name="kucun" id="kucun" value="{$aRow.kucun}" >
