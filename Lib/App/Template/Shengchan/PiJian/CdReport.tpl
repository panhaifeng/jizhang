...
<form name="cdform" id="cdform" action="{url controller=$smarty.get.controller action='FlawReport'}" method="post">
<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
      <td>
         <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
           <tr>
              <td class="tr1">订单编号:{$arr_condition.orderCodeNew}</td>
  ...
  <tr>
      <td>
         <table  border="0" align="center" cellpadding="0" cellspacing="0" class="tableHaveBorder">
           <tr>
              <td align="center" width="5%">件号</td>
              <td align="center" width="5%">缸号</td>
              <td align="center" width="10%">称前重量</td>
              <!-- <td align="center" width="5%">色号</td> -->
              <!-- <td align="center" width="10%">门幅</td>
              <td align="center" width="10%">克重</td> -->
              <td align="center" width="10%">数量</td>
              <td align="center" width="10%">长度</td>
              <td align="center" width="10%">验布工</td>
              <td id="cdqkfather" width="30%">疵点情况</td>
              <td align="center" width="10%">总扣分</td>
              <!-- <td>每100平方码扣分</td> -->
           </tr>
           ...
           <tr style="border-collapse:collapse">
              ...
              <td >
              <table border="0" cellpadding="0" cellspacing="0"  rules="all" frame="rhs">
                <tr id="cdqkson">
                  <td>长度</td>
...
<input type="submit" id="button1" name="button1" value="导出" />
<input type="hidden" id="fCode" name="fCode" value="{$arr_condition.orderCode}"  />
<input type="hidden" id="curDate" name="curDate" value="{$arr_condition.date}"  />
</div>
</form>
{*搜索信息*}
...
<script type="text/javascript">
  $(function(){
    // $('#ganghao').autocomplete('?controller=Shengchan_Zhengli_Send&action=GetGanghaoByAjax', {
    //     minChars:1,
    //     remoteDataType:'json',
    //     useCache:false,
    //     sortResults:false
    ...
    //  $('#pihao').autocomplete('?controller=Shengchan_Zhengli_Send&action=GetHzlPiaohao', {
    //     minChars:1,
    //     remoteDataType:'json',
    //     useCache:false,
    //     sortResults:false,
    //     onItemSelect:function(v){
    //     $('#ganghao').val(v.data[0].ganghao);
    //   }
    // });
      $('#factoryCode').autocomplete('?controller=Shengchan_Chengpin_Ruku&action=GetFactoryCode', {
        minChars:1,
        remoteDataType:'json',
        useCache:false,
        sortResults:false,
