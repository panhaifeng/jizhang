...
class Controller_Cangku_Chengpin_Kcdb extends Controller_Cangku_Chuku {
	function __construct() {
		$this->_state = '成品';
        $this->_kind = '调货出库';
        $this->_kindRu = '调货入库';
        $this->_modelRuk = &FLEA::getSingleton('Model_Cangku_Chengpin_Ruku');
		parent::__construct();
	}
    ...
    function actionDiaoBo(){
        ...
        //库位
        $str="select kuweiName,id from jichu_kuwei where type='{$this->_state}'";
    ...
    function actionSaveDiaoBo(){
        ...
        //跳转
        js_alert(null,'window.parent.showMsg("保存成功!")',url('Cangku_Chengpin_ChukuSell','Report'));
    }
